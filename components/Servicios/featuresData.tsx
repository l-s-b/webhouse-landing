...
const featuresData: Servicio[] = [
  {
    ...
    features: [
      ...
      "Gestión y actualización de tecnologías",
      "Ajustes de contenido en menos de 24hs",
      "Soporte prioritario: Respuesta en minutos"
    ],
    price: "Desde US$50/mes",
    comment: "¡primer mes gratis!"
  },
  {
    id: 2,
    icon: (
    ...
    features: [
      "Modernización UX/UI",
      "Pruebas A/B: Validamos juntos el nuevo diseño",
      "Incluye 2 revisiones generales"
    ],
    price: "Consultar precio",
    comment: "según complejidad"
  },
  {
    id: 3,
    icon: (
    ...
    title: "Newsletters Impactantes",
    features: [
      "Servicio mínimo: una campaña automatizada por semana",
      "Correo electrónico con dominio propio",
      "Copywriting (redacción persuasiva) incluido"
    ],      
    price: "Desde US$100/mes",
    comment: "(Todo incluido, sin sorpresas)"
  }
];
